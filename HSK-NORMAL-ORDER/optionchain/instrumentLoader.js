...
async function loadInstruments() {
    ...
    try {
        ...
        if (instruments.length > 0) {
            ...
            console.log(
                "✅ INSTRUMENT MASTER ALREADY LOADED"
            );
        ...
        if (
            ...
            console.log(
                "📂 LOADING EXISTING INSTRUMENT CSV"
            );
        ...
        if (
            ...
            throw new Error(
                "Instrument master loaded but contains 0 instruments"
            );
